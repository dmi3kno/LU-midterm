...
#google-scholar: true
bibliography: "`r rbbt::bbt_write_bib('midterm-seminar-proposal.bib', ignore=c('fig-moebius', 'fig-modelgraph', 'fig-shelf', 'fig-shelf-pdf', 'fig-shelf-cdf', 'fig-qpds'),overwrite = TRUE)`"
---
